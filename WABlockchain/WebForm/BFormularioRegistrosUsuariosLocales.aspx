                    ...
                    <div class="datos">
                        ...
                        <div>
                           <%-- <label for="">Correo :<input  runat="server" ID="Date2" name="fechaActual" type="text" onchange="handler(event);" ></label><br>--%>
                            <label for="">Rol Usuario :<asp:DropDownList ID="ddlRolUser" runat="server" Height="16px" style="margin-left: 0px" Width="129px" OnSelectedIndexChanged="ddlRolUser_SelectedIndexChanged"></asp:DropDownList></label><br>
                            &nbsp;</div>
                        <div>
