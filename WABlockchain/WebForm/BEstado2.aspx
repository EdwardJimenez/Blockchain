<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/MPInicio.Master" AutoEventWireup="true" CodeBehind="BEstado2.aspx.cs" Inherits="WABlockchain.WebForm.BEstado2" %>
                    ...
                    <div class="caja">
                        <div style="width: 332px; height: 425px; margin-left: 9px;">
                            <div class="datos">
                                <div>
                                    <fieldset id="field">
                                        <legend class="sub">Lista de Titulos a la espera de su confirmación
                                        </legend>
                                        <div style="overflow: auto; height: 250px">
                                            <asp:GridView ID="grvTitulos" CssClass="gridview" runat="server" CellPadding="10" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Button runat="server" OnClick="Actualizar_Click" CommandName="Actualizar" HeaderText="Actualizar" ItemStyle-CssClass="btButton" Text="Confirmar" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>
