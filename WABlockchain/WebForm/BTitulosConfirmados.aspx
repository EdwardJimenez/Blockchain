<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra/MPInicio.Master" AutoEventWireup="true" CodeBehind="BTitulosConfirmados.aspx.cs" Inherits="WABlockchain.WebForm.BTitulosConfirmados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        <fieldset>
            <legend class="bold">TITULOS CONFIRMADOS</legend>
            <div class="boton">
                <br />
            ...
            <div class="Registrar">
                <asp:Button ID="btnOk" class="btn" runat="server" Text="ACEPTAR" Width="109px" />
            </div>
        </fieldset>
    </form>
</asp:Content>
